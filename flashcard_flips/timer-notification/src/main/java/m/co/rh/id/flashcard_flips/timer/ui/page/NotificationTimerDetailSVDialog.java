...
package m.co.rh.id.flashcard_flips.timer.ui.page;
...
import m.co.rh.id.flashcard_flips.base.entity.Deck;
import m.co.rh.id.flashcard_flips.base.entity.NotificationTimer;
import m.co.rh.id.flashcard_flips.base.exception.ValidationException;
import m.co.rh.id.flashcard_flips.base.provider.IStatefulViewProvider;
...
import m.co.rh.id.flashcard_flips.timer.R;
import m.co.rh.id.flashcard_flips.timer.provider.command.NewNotificationTimerCmd;
import m.co.rh.id.flashcard_flips.timer.provider.command.UpdateNotificationTimerCmd;
...
public class NotificationTimerDetailSVDialog extends StatefulViewDialog<Activity> implements RequireComponent<Provider>, View.OnClickListener {
    ...
    private transient NumberPicker.OnValueChangeListener mPeriodOnValueChangeListener;
    ...
    public void provideComponent(Provider provider) {
        ...
        mPeriodOnValueChangeListener = (numberPicker, oldVal, newVal) ->
    ...
    protected View createView(Activity activity, ViewGroup container) {
        ...
        numberPickerMinute.setOnValueChangedListener(mPeriodOnValueChangeListener);
    ...
    public void dispose(Activity activity) {
        ...
        mPeriodOnValueChangeListener = null;
    }
    ...
    public void onClick(View view) {
        ...
        if (id == R.id.button_save) {
            if (mNewNotificationTimerCmd.valid(mNotificationTimer)) {
                ...
                mLogger.i(TAG, mNewNotificationTimerCmd.getValidationError());
            }
