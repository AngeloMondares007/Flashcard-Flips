...
package m.co.rh.id.flashcard_flips.base.ui.component.common;
...
import m.co.rh.id.flashcard_flips.base.R;
import m.co.rh.id.anavigator.NavRoute;
import m.co.rh.id.anavigator.StatefulViewDialog;
import m.co.rh.id.anavigator.annotation.NavInject;

/**
 * Common boolean dialog that return value true when OK is clicked and false when Cancel is clicked.
 * returned null if dialog is cancelled or dismissed by clicking outside
 */
public class BooleanSVDialog extends StatefulViewDialog<Activity> implements View.OnClickListener {
    ...
    protected View createView(Activity activity, ViewGroup container) {
        ViewGroup rootLayout = (ViewGroup) activity.getLayoutInflater()
                .inflate(R.layout.common_dialog_boolean, container, false);
    ...
    public void onClick(View view) {
        ...
        if (viewId == R.id.button_ok) {
            getNavigator().pop(true);
        } else if (viewId == R.id.button_cancel) {
            getNavigator().pop(false);
        }
    }
