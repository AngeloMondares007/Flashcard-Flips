...
package m.co.rh.id.flashcard_flips.app.provider;
...
import m.co.rh.id.flashcard_flips.app.CardShowActivity;
import m.co.rh.id.flashcard_flips.app.MainActivity;
import m.co.rh.id.flashcard_flips.app.ui.page.CardDetailPage;
import m.co.rh.id.flashcard_flips.app.ui.page.CardListPage;
import m.co.rh.id.flashcard_flips.app.ui.page.CardShowHomePage;
import m.co.rh.id.flashcard_flips.app.ui.page.CardShowPage;
import m.co.rh.id.flashcard_flips.app.ui.page.DeckDetailSVDialog;
import m.co.rh.id.flashcard_flips.app.ui.page.DeckListPage;
import m.co.rh.id.flashcard_flips.app.ui.page.DeckSelectSVDialog;

import m.co.rh.id.flashcard_flips.app.ui.page.NotificationTimerListPage;
import m.co.rh.id.flashcard_flips.app.ui.page.SettingsPage;
import m.co.rh.id.flashcard_flips.app.ui.page.SplashPage;
import m.co.rh.id.flashcard_flips.app.ui.page.TestPage;
import m.co.rh.id.flashcard_flips.base.constants.Routes;
import m.co.rh.id.flashcard_flips.base.provider.navigator.CommonNavConfig;
import m.co.rh.id.flashcard_flips.timer.ui.page.NotificationTimerDetailSVDialog;
