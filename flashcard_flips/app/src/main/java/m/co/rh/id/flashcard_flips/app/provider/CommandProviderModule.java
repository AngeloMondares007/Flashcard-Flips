...
import m.co.rh.id.flashcard_flips.app.provider.command.CopyCardCmd;
import m.co.rh.id.flashcard_flips.app.provider.command.DeckQueryCmd;
import m.co.rh.id.flashcard_flips.app.provider.command.DeleteCardCmd;
import m.co.rh.id.flashcard_flips.app.provider.command.DeleteDeckCmd;
import m.co.rh.id.flashcard_flips.app.provider.command.ExportImportCmd;
import m.co.rh.id.flashcard_flips.app.provider.command.MoveCardCmd;
import m.co.rh.id.flashcard_flips.app.provider.command.NewCardCmd;
import m.co.rh.id.flashcard_flips.app.provider.command.NewDeckCmd;
import m.co.rh.id.flashcard_flips.app.provider.command.PagedCardItemsCmd;
import m.co.rh.id.flashcard_flips.app.provider.command.PagedDeckItemsCmd;
import m.co.rh.id.flashcard_flips.app.provider.command.UpdateCardCmd;
import m.co.rh.id.flashcard_flips.app.provider.command.UpdateDeckCmd;
import m.co.rh.id.flashcard_flips.bot.provider.BotCommandProviderModule;
import m.co.rh.id.flashcard_flips.timer.provider.NotificationTimerCmdProviderModule;
